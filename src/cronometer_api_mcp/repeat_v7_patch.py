"""Encode recurring-food meal groups in the confirmed raw group slot.

The captured Breakfast request contains ``...days|0|11|1|...`` and its
getRepeatedItems response contains raw group 0. Live tests changing the scalar
after the food-name reference did not change the returned meal group. Therefore
the zero immediately before the food-name string reference is the meal-group
slot; public groups 1..4 are serialized there as 0..3. The following scalar is
kept at the captured value 1.
"""
